...
struct Offsets
{
        ...
        DWORD isSetWeapon = getAbsoluteAddress(LibraryToLoad, 0xEF9C98); // SetWeapon (LocalPlayer)
        ...
        DWORD isSetWeapon = getAbsoluteAddress(LibraryToLoad, 0x12D381C); // SetWeapon (LocalPlayer)
